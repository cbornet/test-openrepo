...
[![Build Status](https://travis-ci.org/cbornet/test-openrepo.svg?branch=master)](https://travis-ci.org/cbornet/test-openrepo)
...
6. If you did everything correct, https://cbornet.github.io/test-openrepo/ will lead to your new docs
...
- Documentation(ReDoc): https://cbornet.github.io/test-openrepo/
- SwaggerUI: https://cbornet.github.io/test-openrepo/swagger-ui/
- Look full spec:
    + JSON https://cbornet.github.io/test-openrepo/swagger.json
    + YAML https://cbornet.github.io/test-openrepo/swagger.yaml
- Preview spec version for branch `[branch]`: https://cbornet.github.io/test-openrepo/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://cbornet.github.io/test-openrepo/ with url from the message: `Server started <url>`
